from proveta import diffusion_length, diffusion_length_time_residence, final_positions, exciton_shift, ld_residence_time,\
    ld_residence_time_average, life_time
